...
1. 코드스테이츠(자바스크립트) 오티 듣기

사실 아무리 봐도 내가 관심있는 분야는 인공지능이라
데이터 사이언스 수업을 듣고 싶은데
아 생각보다 저렴하거나 무료로 데이터사이언스 관련된 부트캠프를
찾기 쉽지 않다. 코세라는 너무...어나더레벨이라 몇 번 봤지만
여전히 어렵고 한국 사이트들은 대체 왜 그렇게 90년대 방식으로
설명하는지 모르겠다. 딱, 칸아카데미 플랫폼과 수준을 가진
무료 강의가 있으면 좋겠지만 ㅠㅜ 화학이랑 영어를 같이 진행하니
당장 컴퓨터 사이언스 공부도 못하고 있어서 부트캠프 형식의 공부가 절실하다. 부트캠프ㅠㅜㅜㅜ 너무 하고 싶다.
 하지만 자바스크립트...내가 좋아하는 인터랙션을 컴퓨터로
할 수 있는 좋은 언어인 듯 하여 배우고 싶기도 하고 승범교수님 덕분에 그나마 지식이 있고 코딩트레인도 있기 때문에 차라리 얘를 그냥 취미삼아 꾸준히 하다가 넘어가는게 좋을 거 같기도 하고...
